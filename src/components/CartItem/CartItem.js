        ...
        <div className="cart-item__information">
          <div className="cart-item__information--left">
            <div className="cart-item__information--top">
              <h3 className="cart-item__name cart-item__text">
                {item.cardName}
              </h3>
              <p className="cart-item__set-rarity cart-item__text">
                {item.cardCode} {item.rarity}
              </p>
              <p className="cart-item__description cart-item__text">
                {item.description}
              </p>
            </div>
            <p
              className={
                darkMode
                  ? "cart-item__item-remove darkmoderemove"
                  : "cart-item__item-remove"
              }
